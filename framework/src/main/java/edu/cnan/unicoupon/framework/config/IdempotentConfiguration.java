package edu.cnan.unicoupon.framework.config;

import edu.cnan.unicoupon.framework.idempotent.NoDuplicateSubmitAspect;
import edu.cnan.unicoupon.framework.idempotent.NoMQDuplicateConsumeAspect;
