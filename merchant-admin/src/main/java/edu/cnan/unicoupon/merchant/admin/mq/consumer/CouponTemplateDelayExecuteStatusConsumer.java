package edu.cnan.unicoupon.merchant.admin.mq.consumer;
...
@RocketMQMessageListener(consumerGroup = "uni-coupon_merchant-admin-service_coupon-template-delay-status_cg${unique-name:}"
        ,topic = "uni-coupon_merchant-admin-service_coupon-template-delay_topic${unique-name:}")
