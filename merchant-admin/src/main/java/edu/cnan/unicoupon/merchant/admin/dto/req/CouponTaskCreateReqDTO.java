package edu.cnan.unicoupon.merchant.admin.dto.req;
...
public class CouponTaskCreateReqDTO {
     ...
     * 文件地址
     */
    @Schema(description = "目标用户信息文件路径",
            // step1 调用 ExcelGenerateTests 里的单元测试用例，生成 Excel 测试示例文件
            // step2 复制项目目录下 tmp/UniCoupon任务推送Excel 的绝对路径，Windows 和 Mac 下有些许区别，Windows 下应该是 D:\Users\xxx\xxx
            example = "C:\\workspace\\back\\UniCoupon\\tmp\\百万Excel数据.xlsx",
            required = true)
