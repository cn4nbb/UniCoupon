package edu.cnan.onecoupon.merchant.admin.mq.consumer;
...
@RocketMQMessageListener(consumerGroup = "one-coupon_merchant-admin-service_coupon-template-delay-status_cg${unique-name:}"
