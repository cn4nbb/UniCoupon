...
import edu.cnan.unicoupon.distribution.common.enums.CouponTemplateStatusEnum;
...
import edu.cnan.unicoupon.distribution.mq.event.CouponTaskExecuteEvent;
import edu.cnan.unicoupon.distribution.mq.producer.CouponExecuteDistributionProducer;
import edu.cnan.unicoupon.distribution.service.handler.excel.CouponTaskExcelObject;
import edu.cnan.unicoupon.distribution.service.handler.excel.ReadExcelDistributionListener;
import edu.cnan.unicoupon.framework.idempotent.NoMQDuplicateConsume;
...
@RocketMQMessageListener(
        topic = "uni-coupon_distribution-service_coupon-task-execute_topic${unique-name:}",
        consumerGroup = "uni-coupon_distribution-service_coupon-task-execute_cg${unique-name:}"
)
